...
namespace DataAccessLayerTests
{
    ...
    public class RecordingGatewayFixture : RecordingFixture
    {
        ...
        public void RetrieveRecordingFromDatabase()
        {
            ...
            RecordingDataSet.Recording loadedRecording = recordingGateway.FindById(Builder.RecordingId, loadedFromDB);
        ...
        public void UpdateTitleFieldInRecording()
        {
            ...
            RecordingDataSet.Recording recording = base.Recording;
